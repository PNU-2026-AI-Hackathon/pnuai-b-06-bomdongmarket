...
```powershell
cd "C:\Users\user\Desktop\해커톤 프로젝트\Profit_Calculator 0.2.2"
python main.py
```
...
- 현재 공간·환경조건은 프로그램 실행용 샘플이며, 작물 생산정보와 판매가격은 사용자가 입력한 현재 기준값입니다.
...
- 전체 월 매출: `38,159,910원`
- 방식 1 사업 영업이익: `112,388원`
- 방식 2 공간 대여자 예상수익: `7,984,440원`
- 방식 2 농부 예상수익: `2,661,480원`
- 방식 2 사업 영업이익: `2,661,480원`

현재 데이터에서는 사업장별 손익이 다르며, 음수로 표시되는 결과는 계산 오류가 아니라 설정된 생산량, 판매가격, 인건비, 전력비 조합에 따른 결과입니다.
